...
WebUI.closeBrowser()
				...
				WebUI.openBrowser('https://stg-mcv2.9pay.mobi/')
						...
						textoduchodoisoatduyet=WebUI.getText(findTestObject('Page_Dashboard/soduchodoisoat'))
						System.out.println(textoduchodoisoatduyet)
						soduchodoisoatduyet = 0
						
						oduchodoisoatduyet = textoduchodoisoatduyet.replace(',', '')
