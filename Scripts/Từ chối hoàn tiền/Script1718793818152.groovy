		...
		WebUI.click(findTestObject('Page_Create Refund Request/button_Send Request'))
		 ...
		 System.out.println ('Confirm: ' + confirm)
		  ...
		  if (trusodu<= Integer.parseInt(soduchodoisoat)) {
                ...
                WebUI.setText(findTestObject('Page_cms-payment - Login/input_usernameCMS'), usernamecms)

                WebUI.setText(findTestObject('Page_cms-payment - Login/input_passwwordCMS'), passwordcms)
